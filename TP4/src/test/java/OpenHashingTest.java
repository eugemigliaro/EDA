...
public class OpenHashingTest {
    ...
    private OpenHashing<Integer, String> instance;

    @BeforeEach
    public void setUp() {
        instance = new OpenHashing<>(f -> f);
    }

    @Test
    @DisplayName("Test constructor with null hash function")
    public void testConstructorWithNullHashFunction() {
        Exception exception = assertThrows(RuntimeException.class, () -> {
            new OpenHashing<Integer, String>(null);
        }, "Should throw RuntimeException for null hash function");
        assertTrue(exception.getMessage().contains("fn not provided"), 
                "Exception message should mention function not provided");
    }
    ...
    public void testCollisionHandling() {
        ...
        OpenHashing<Integer, String> collisionInstance = new OpenHashing<>(f -> 1);
    ...
    public void testCustomHashFunction() {
        ...
        OpenHashing<String, Integer> customInstance = new OpenHashing<>(s -> s.length());
